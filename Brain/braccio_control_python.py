...
# Updated servo values based on your arm model
base =[0,0,180,0]  # default, min, max, write location
shoulder=[70,0,170,1]
elbow=[100,10,108,2]
wrist=[150,15,180,3]
wristRot=[90,0,166,4]
...
arm = serial.Serial('COM3', 115200, timeout=5)
...
# Call the home function after it has been defined
home()
